...
# data_iga2[, num_t_date := as.numeric(`T-date` - `T-date`) / 365]
# data_iga2[, num_t_dls := as.numeric(`T-dls` - `T-date`) / 365]
# data_iga2[, num_date_biopsy := as.numeric(`date of biopsy` - `T-date`) / 365]
# data_iga2[, num_date_birth := as.numeric(`Date of birth` - `T-date`) / 365]  # negative
# data_iga2[, num_graft_loss := as.numeric(`graft loss date` - `T-date`) / 365]
# data_iga2[, num_date_follow_up := as.numeric(`T-date` + follow_up) / 365]

data_iga2[, time_date_biopsy := interval(`T-date`, `date of biopsy`) / years(1)]
data_iga2[, time_t_dls := interval(`T-dls`, `T-date`) / years(1)]
